...
É estimado atualmente que 60\% da produção de petróleo no mundo advém de operações Offshore, e para atender essa demanda cada vez mais crescente é de extrema importância que os produtos localizados abaixo da superfície tenham durabilidade e tempo de vida estendidos. Tubulações submersas tem uma expectativa de vida útil de 30-50 anos para que isso seja efetivado se faz necessário uso de tecnologias que possam gerenciar estes componentes submersos, preservando assim sua integridade. \cite{virtualizacao}
